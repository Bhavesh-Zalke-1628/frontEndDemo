...
const calculators = [
    ...
    //     icon: "🧾",
    //     formula: (income, taxRate) => (income * taxRate).toFixed(2),
    //     inputs: [
    //         { label: "Taxable Income", unit: "₹" },
    //         { label: "Tax Rate", unit: "%" },
    //         { label: "Deductions", unit: "₹" }
    //     ]
    // }
];
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 py-12 px-4 sm:px-6 lg:px-8">
            ...
            >
                ...
                >
                    <p>Need help? Contact our financial advisors for personalized advice.</p>
                </motion.div>
            </motion.div>
        </div>
    );
